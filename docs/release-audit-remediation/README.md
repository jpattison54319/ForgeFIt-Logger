...
|----|-------|-----|--------|------|-----|-------------|----------|------|---------|-----|
| FF-001 | [Localized weight parsing](stories/FF-001-localized-weight-parsing.md) | P1 | In Review | — | DeepSeek V4 Flash 0731 | pending | WeightInputParser suite + LocalizedWeightEntryTests + de_DE XCUITest | pkg 400+87 pass; iOS 26.5 sim 39/7 pass; iOS+Watch builds pass | Sim: de_DE iOS 26.5 XCUITest pass; Hw: physical iPhone outstanding | — |
| FF-002 | [Watch terminal command identity](stories/FF-002-watch-terminal-command-identity.md) | P1 | In Review | — | DeepSeek V4 Flash 0731 | pending | WatchSyncTests + WatchTerminalCommandIdentityTests + WatchStructuredSetSyncTests | pkg 400+87 pass; iOS 26.5 sim 39/7 pass; iOS+Watch builds pass | Sim: interactive Watch run outstanding; Hw: outstanding | — |
