...
| `yoga_extended_side_angle` | Extended Side Angle Pose (Utthita Parsvakonasana) | Side view: left knee bent in a wide lunge, right leg straight, torso tilted left over the front thigh, left forearm or hand reaching down inside the left foot, right arm extended in a straight diagonal line over the ear. |
